...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_dictionary:
        ...
        county_votes = county_dictionary.get(county_name)
        ...
        if (county_votes > largest_county_vote_number) and (county_vote_percentage > largest_county_percentage):
            largest_county_vote_number = county_votes
