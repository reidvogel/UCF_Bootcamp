...
// D3-1 We create the third tile layer that will be the background of our map.
...
let overlays = {
  ...
  // D2-2 add new layer to the overlay
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(majorData) {
    ...
    // D2-8 Add the major eathquakes layer to the map.
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(techtonicData) {
    ...
    // add the techtonic layer group variable to tehe map
